...
namespace titanium {
	namespace bindings {
		...
		BindEntry* SruBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.sru.SruModule", ::de::appwerft::sru::SruModule::bindProxy, ::de::appwerft::sru::SruModule::dispose},
				{"de.appwerft.sru.EndpointProxy", ::de::appwerft::sru::sru::EndpointProxy::bindProxy, ::de::appwerft::sru::sru::EndpointProxy::dispose}
			};
